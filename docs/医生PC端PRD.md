...
- 支持事件类型筛选：全部、管理方案、随访、预警、医嘱与指导、设备/报告、关键记录。
...
- P0 必须保留预警到复测、随访、医嘱与指导、管理方案调整入口的闭环。
...
- 随访是结构化慢病管理复盘，不是问诊服务。
- 随访可以生成医嘱与指导、补充任务、复诊/转诊建议或管理方案调整，但不承载实时问诊聊天。

P0 目标：

- 判断患者是否按管理方案执行。
- 判断关键指标、症状、用药、设备数据是否改善或恶化。
- 判断是否需要继续当前方案、调整方案、补充数据、发医嘱与指导、建议复诊/转诊或安排下次随访。
...
- 管理方案、随访、预警、医嘱与指导、设备报告等关键事件写入时间轴。
